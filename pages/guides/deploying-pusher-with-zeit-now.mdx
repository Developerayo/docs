...
export const meta = {
  ...
  lastEdited: '2019-08-23T12:04:50.000Z'
}

WebSockets have enabled realtime online experiences like collaborative document editing, multiplayer games, and interactive chatrooms. Solutions such as [socket.io](https://socket.io) have made writing WebSocket servers a breeze, but what if our backend is a serverless lambda function with limited execution times?

By design, serverless functions have maximum execution limits and should aim to respond to the client as quick as possible. An open WebSocket connection would require processes to live until the connection is closed, which can be well over the maximum execution time. Solutions like [Pusher Channels](https://pusher.com/channels) solve complex realtime infrastructure problems so you don’t have to. All you need is a single serverless function to _publish_ or _push_ some data, and a client to _subscribe_ to channels and data events.
